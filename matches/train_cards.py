...
def predict_means(row: pd.Series, mapping: Dict[str, Any], mean_floor: float = 0.05) -> Tuple[float, float]:
    eps = 1e-6
    def _clip(x):
...
def main():
    ...
    # -------- Load data
    print(f"[INFO] Loading rows (cards: {which})...")
    ...
    artifacts = {
        ...
        "metrics": metrics,
        "notes": "Cards (yellow/red/total) trained from MatchStats; GLM optional, safe constants fallback.",
    }
